...
/**
 * Base class for adb client exceptions.
 */
public class AdbClientException extends Exception {

	private final ExceptionCode code;

	public AdbClientException(ExceptionCode code, String message) {
		super(message);
		this.code = code;
	}

	public AdbClientException(ExceptionCode code, String message, Throwable cause) {
		super(message, cause);
		this.code = code;
	}
	...
	public static AdbClientException fromSqlException(SQLException e) {
		ExceptionCode code = ExceptionCode.UNKNOWN_ERROR;
		if ((e.getMessage() != null && (e.getMessage().contains("This connection has been closed")
		...
		return new AdbClientException(code, msg, e);
	}
}

...
package com.alibaba.cloud.analyticdb.adb3client.model;

import com.alibaba.cloud.analyticdb.adb3client.util.ArrayUtil;
	...
	private long getObjByteSize(int index, Object obj) {
		...
		switch (column.getType()) {
			...
			default:
				...
				if (obj instanceof byte[]) { // RoaringBitmap, bytea 等类型
					ret = ((byte[]) obj).length;
				} else {
					ret = 4;
				}
